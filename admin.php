...
<textarea id="bulkNames" rows="6" class="cyber-input"
...
<button onclick="startBulkProduction()"
class="w-full bg-emerald-600 text-black font-black py-4 rounded-lg text-[11px] uppercase tracking-widest">
